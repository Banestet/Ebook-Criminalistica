...
(function(a) {
        ...
        if (typeof k === "string") {
            ...
            a(this).each(function() {
                ...
                if (i) {
                    c = k;
                    h = [];
                    if (typeof f !== "undefined") { h.push(f) }
                    if (typeof d !== "undefined") { h.push(d) }
                    if (i[c]) { g = i[c].apply(i, h); if (typeof g !== "undefined" || g) { l.push(i[c].apply(i, h)) } } else { a.error('Method "' + c + '" does not exist on jQuery.booklet.') }
                } else { a.error('jQuery.booklet has not been initialized. Method "' + k + '" cannot be called.') }
            });
            if (l.length == 1) { return l[0] } else { if (l.length > 0) { return l } else { return a(this) } }
        } else {
            if (typeof k === "number") {
                return a(this).each(function() {
                    ...
                    if (i) {
                        j = k;
                        i.gotopage(j)
                    } else { a.error("jQuery.booklet has not been initialized.") }
                })
            } else {
    ...
    function b(bg, a7) {
        var aH = bg,
            ...
            aR = false,
            Q = false,
            o = { empty: '<div class="b-page-empty" title=""></div>', blank: '<div class="b-page-blank" title=""></div>', sF: '<div class="b-shadow-f"></div>', sB: '<div class="b-shadow-b"></div>' },
            aO = { leftToRight: "LTR", rightToLeft: "RTL" },
            aN = {},
            am = {},
            e, a1, C, u = [],
            an = "",
            az = "/page/",
            al, ag, ae, ai, at, z, ax, t, V, aG, aF, aD, aB, ay, bd, aP, af, D, k, bb, a2, bc, be, aL, s, aU, B, a0, aZ, aq, aX, aV, x, U, T, P, O, m, l, w, aE, p, a4, Y, S, n, d, aT, aC, aK, c, a8, X, ad, ap, aw, I, K, ar, av, y, aY, E = { create: "bookletcreate", start: "bookletstart", change: "bookletchange", add: "bookletadd", remove: "bookletremove" },
            L, a5 = function(h, bi, bh) {
                var j = "",
                    bj = "",
                    i;
                if (h.attr("rel")) { j = h.attr("rel") }
                if (h.attr("title")) { bj = h.attr("title") }
                if (h.hasClass("b-page-empty")) { h.wrap('<div class="b-page"><div class="b-wrap"></div></div>') } else { if (bh.closed && bh.covers && (bi == 1 || bi == bh.pageTotal - 2)) { h.wrap('<div class="b-page"><div class="b-wrap b-page-cover"></div></div>') } else { if (bi % 2 != 0) { h.wrap('<div class="b-page"><div class="b-wrap b-wrap-right"></div></div>') } else { h.wrap('<div class="b-page"><div class="b-wrap b-wrap-left"></div></div>') } } }
                ...
                if (bh.pageNumbers && !h.hasClass("b-page-empty") && (!bh.closed || (bh.closed && !bh.covers) || (bh.closed && bh.covers && bi != 1 && bi != bh.pageTotal - 2))) {
                    if (bh.direction == aO.leftToRight) { t++ }
                    h.parent().append('<div class="b-counter">' + t + "</div>");
                    if (bh.direction == aO.rightToLeft) { t-- }
                }
            ...
            aQ = function() {
                ...
                au = true;
                Q = false;
                L = { options: a.extend({}, aI), index: aI.currentIndex, pages: [u[aI.currentIndex].contentNode, u[aI.currentIndex + 1].contentNode] };
                if (aI.create) { aH.off(E.create + ".booklet").on(E.create + ".booklet", aI.create) }
            ...
            r = function() {
                u = [];
                if ((aH.children().length % 2) != 0) { if (aI.closed && aI.covers) { aH.children().last().before(o.blank) } else { aH.children().last().after(o.blank) } }
                if (aI.closed) {
                ...
                if (aI.direction == aO.rightToLeft) {
                    ...
                    if (aI.closed) { t -= 2 }
                    if (aI.covers) { t -= 2 }
                    a(aH.children().get().reverse()).each(function() { a(this).appendTo(aH) })
                }
                if (!au) {
                    if (aI.direction == aO.leftToRight) { aI.currentIndex = 0 } else { if (aI.direction == aO.rightToLeft) { aI.currentIndex = aI.pageTotal - 2 } }
                    if (!isNaN(aI.startingPage) && aI.startingPage <= aI.pageTotal && aI.startingPage > 0) {
                        if ((aI.startingPage % 2) != 0) { aI.startingPage-- }
            ...
            aJ = function() {
                ...
                aF.css(aN.p1);
                aD.css(aN.p2);
                if (aI.closed && aI.autoCenter && aI.currentIndex >= aI.pageTotal - 2) { aD.hide() }
                V.css(aN.pN);
                aG.css(aN.p0);
                aB.stop().css(aN.p3);
                ay.css(aN.p4);
                ...
                if (aI.closed && aI.autoCenter && (aI.currentIndex == 0 || aI.currentIndex >= aI.pageTotal - 2)) {
                    if (aI.overlays) { B.width("100%") }
                    aH.width(K)
                } else {
                    if (aI.overlays) { B.width("50%") }
                    aH.width(aI.width)
                }
            ...
            ak = function() {
                ...
                if (aI.direction == aO.rightToLeft) { a(aH.children().get().reverse()).each(function() { a(this).appendTo(aH) }) }
            },
            a6 = function(i) {
                var h = false;
                ...
                if (!aI.width) { aI.width = aH.width() } else {
                    if (typeof aI.width == "string" && aI.width.indexOf("px") != -1) { aI.width = aI.width.replace("px", "") } else {
                ...
                if (!aI.height) { aI.height = aH.height() } else {
                    if (typeof aI.height == "string" && aI.height.indexOf("px") != -1) { aI.height = aI.height.replace("px", "") } else {
                ...
                y = aI.height;
                aY = aI.speed / 2;
                if (aI.closed && aI.autoCenter) { if (aI.currentIndex == 0) { aH.width(K) } else { if (aI.currentIndex >= aI.pageTotal - 2) { aH.width(K) } } }
                if (aI.shadows) {
                ...
                if (aI.name) { document.title = aI.name } else { aI.name = document.title }
                ac();
                if (au) { ba() }
                if (aI.menu && a(aI.menu).length > 0) {
                    w = a(aI.menu);
                    if (!w.hasClass("b-menu")) { w.addClass("b-menu") }
                    if (aI.pageSelector && w.find(".b-selector-page").length == 0) {
                        ...
                        for (ag = 0; ag < aI.pageTotal; ag += 2) {
                            ae = ag;
                            S = (ae + 1) + "-" + (ae + 2);
                            if (aI.closed) { ae--; if (ag == 0) { S = "1" } else { if (ag == aI.pageTotal - 2) { S = aI.pageTotal - 2 } else { S = (ae + 1) + "-" + (ae + 2) } } if (aI.covers) { ae--; if (ag == 0) { S = "" } else { if (ag == aI.pageTotal - 2) { S = "" } else { S = (ae + 1) + "-" + (ae + 2) } } } }
                            if (ag == 0) { a4.find(".b-current").text(S) }
                            n = u[ag].title;
                            if (n == "") { n = u[ag + 1].title }
                            if (aI.direction == aO.rightToLeft) { n = u[Math.abs(ag - aI.pageTotal) - 1].title; if (n == "") { n = u[Math.abs(ag - aI.pageTotal) - 2].title } }
                            d = a('<li><a href="#' + az + (ag + 1) + '" id="selector-page-' + ag + '"><span class="b-text">' + n + '</span><span class="b-num">' + S + "</span></a></li>").appendTo(Y);
                            if (!aI.hash) {
                                d.find("a").on("click.booklet", function(j) {
                                    j.preventDefault();
                                    if (aj || Q) { return }
                                    if (aI.direction == aO.rightToLeft) {
                                        a4.find(".b-current").text(a(this).find(".b-num").text());
                                        F(Math.abs(parseInt(a(this).attr("id").replace("selector-page-", "")) - aI.pageTotal) - 2)
                                    } else { F(parseInt(a(this).attr("id").replace("selector-page-", ""))) }
                                })
                            }
                        }
                        aT = Y.height();
                        Y.css({ height: 0, "padding-bottom": 0 });
                        a4.on("mouseenter.booklet", function() { Y.stop().animate({ height: aT, paddingBottom: 10 }, 500) }).on("mouseleave.booklet", function() { Y.stop().animate({ height: 0, paddingBottom: 0 }, 500) })
                    } else {
                        if (!aI.pageSelector) {
                    ...
                    if (aI.chapterSelector && w.find(".b-selector-chapter").length == 0) {
                        ...
                        if (aC == "") { aC = u[aI.currentIndex + 1].chapter }
                        ...
                        for (ag = 0; ag < aI.pageTotal; ag += 1) {
                            if (u[ag].chapter != "" && typeof u[ag].chapter != "undefined") {
                                ...
                                } else { a8 = a('<li><a href="#' + az + (ag + 1) + '" id="selector-page-' + ag + '"><span class="b-text">' + u[ag].chapter + "</span></a></li>").appendTo(c) }
                                if (!aI.hash) {
                                    a8.find("a").on("click.booklet", function(bh) {
                                        bh.preventDefault();
                                        var j;
                                        if (aj || Q) { return }
                                        if (aI.direction == aO.rightToLeft) {
                                        ...
                                        } else { j = parseInt(a(this).attr("id").replace("selector-page-", "")) }
                                        if (j % 2 != 0) { j -= 1 }
                                        F(j)
                                    })
                                }
                        ...
                        aK.on("mouseenter.booklet", function() { c.stop().animate({ height: X, paddingBottom: 10 }, 500) }).on("mouseleave.booklet", function() { c.stop().animate({ height: 0, paddingBottom: 0 }, 500) })
                    } else {
                    ...
                    w = null;
                    if (aI.menu) { a(aI.menu).removeClass("b-menu") }
                    aH.find(".b-selector").remove()
                }
                aU = aH.find(".b-controls");
                if (aU.length == 0) { aU = a('<div class="b-controls"></div>').appendTo(aH) }
                if (aI.manual && a.ui) { aI.overlays = false }
                if (P) {
                    P.off("click.booklet");
                    P = null
                }
                ...
                if (aI.tabs && aq.length > 0) {
                    if (aI.tabWidth) { aq.width(aI.tabWidth) }
                    if (aI.tabHeight) { aq.height(aI.tabHeight) }
                ...
                if (aI.overlays && aI.hovers) {
                    m.on("mouseover.booklet", function() { aW(true) }).on("mouseout.booklet", function() { ab(true) });
                    l.on("mouseover.booklet", function() { aW(false) }).on("mouseout.booklet", function() { ab(false) })
                }
                if (aI.arrows) {
                    if (aI.arrowsHide) {
                        if (a.support.opacity) {
                            m.on("mouseover.booklet", function() { U.find("div").stop().fadeTo("fast", 1) }).on("mouseout.booklet", function() { U.find("div").stop().fadeTo("fast", 0) });
                            l.on("mouseover.booklet", function() { T.find("div").stop().fadeTo("fast", 1) }).on("mouseout.booklet", function() { T.find("div").stop().fadeTo("fast", 0) })
                        } else {
                            m.on("mouseover.booklet", function() { U.find("div").show() }).on("mouseout.booklet", function() { U.find("div").hide() });
                            l.on("mouseover.booklet", function() { T.find("div").show() }).on("mouseout.booklet", function() { T.find("div").hide() })
                        }
                    } else {
                        U.find("div").show();
                        T.find("div").show()
                ...
                a(document).on("keyup.booklet", function(j) { if (j.keyCode == 37 && aI.keyboard) { M() } else { if (j.keyCode == 39 && aI.keyboard) { aM() } } });
                clearInterval(ai);
                ai = null;
                if (aI.hash) {
                    ao();
                    clearInterval(ai);
                    ai = setInterval(function() { aA() }, 250)
                }
                a(window).on("resize.booklet", function() { if ((ad || aw)) { a3() } });
                if (aI.auto && aI.delay) {
                    clearInterval(at);
                    at = setInterval(function() { if (aI.direction == aO.leftToRight) { aM() } else { M() } }, aI.delay);
                    aS = true;
                    ...
                    clearInterval(at);
                    at = null;
                    if (aI.pause && a(aI.pause).length > 0) { a(aI.pause).off("click.booklet") }
                    aE = null;
                    if (aI.play && a(aI.play).length > 0) { a(aI.play).off("click.booklet") }
                    p = null;
                    aS = false
                }
                if (h) {
                    ...
                    if (aI.manual) {
                        aB.draggable({
                            ...
                            drag: function(bp, bq) {
                                ...
                                if (aI.shadows) { bc.css({ right: "-" + (aI.shadowTopFwdWidth * bi * 2) + "px" }); if (a.support.opacity) { bc.css({ opacity: bi * 2 }) } else { bc.css({ right: "auto", left: 0.1 * aB.width() }) } }
                                bh = C + bn / 2;
                                bh = bh > K ? K : bh;
                                bk = K - bh;
                            ...
                            stop: function() {
                                ...
                                if (i > aI.hoverThreshold) {
                                    if (aI.shadows && !a.support.opacity) { bc.css({ left: "auto", opacity: 0 }) }
                                    aM();
                                    ...
                                    if (aI.closed && aI.autoCenter) {
                                        ...
                                        } else { aH.animate({ width: aI.width }, am.hover.speed, aI.easing) }
                                    }
                                }
                            }
                        });
                        aG.draggable({
                            axis: "x",
                            containment: [aH.offset().left + C, 0, aH.offset().left + aI.width, y],
                            drag: function(bp, bq) {
                                s = true;
                                ...
                                bn = h - bm;
                                i = bn / (aI.width - bm);
                                if (aI.closed && aI.autoCenter && aI.currentIndex == 2) { i = bn / (K - bm) }
                                if (i > 1) { i = 1 }
                                bi = i < 0.5 ? i : (1 - i);
                                bj = (bi * aI.shadowBtmWidth * 2) + e;
                                bj = bn / bm >= 0.5 ? bj -= e : bj;
                                if (aI.shadows) { if (a.support.opacity) { be.css({ opacity: bi * 2 }) } else { be.css({ left: aI.shadowTopBackWidth * bi * 2 }) } }
                                bh = i * (K - C) + C + bj;
                                bo = bh - bj;
                                j = -bo;
                                if (aI.closed && aI.autoCenter) {
                            ...
                            stop: function() {
                                ...
                                if (i > aI.hoverThreshold) {
                                    ...
                                    if (aI.closed && aI.autoCenter) {
                                        ...
                                        } else { if (aI.currentIndex == aI.pageTotal - 2) { aH.animate({ width: aI.width * 0.5 }, am.hover.speed, aI.easing) } }
                                    }
                                }
                            }
                        });
                        ...
                        aH.off("mousemove.booklet").on("mousemove.booklet", function(bp) {
                            ...
                            if (bn < am.hover.size) { aW(false) } else {
                                if (bn > K - am.hover.size && aI.currentIndex == 0 && aI.autoCenter && aI.closed) { aW(true) } else {
                                    if (bn > am.hover.size && bn <= aI.width - am.hover.size) {
                                        ab(false);
                                        ab(true)
                                    } else { if (bn > aI.width - am.hover.size) { aW(true) } }
                                }
                            }
            ...
            J = function() {
                ...
                if (i.length > 1) { h = parseInt(i[2]) - 1; if (aI.direction == aO.rightToLeft) { h = Math.abs(h + 1 - aI.pageTotal) } return h } else { return "" }
            },
            ah = function(i, h) {
                if (h.hash) {
                    if (h.direction == aO.rightToLeft) { i = Math.abs(i - h.pageTotal) }
            ...
            q = function() {
                if (a.ui) { if (aH.find(".b-page").draggable()) { aH.find(".b-page").draggable("destroy").removeClass("b-grab b-grabbing") } }
                aH.off(".booklet")
            },
            A = function(h, i) {
                if (h == "start") { h = 0 } else { if (h == "end") { h = ax } else { if (typeof h == "number") { if (h < 0 || h > ax) { return } } else { if (typeof h == "undefined") { return } } } }
                if (typeof i == "undefined" || i == "") { return }
                ak();
                bf();
                if (aI.closed && aI.covers && h == ax) { aH.children(":eq(" + (h - 1) + ")").before(i) } else { if (aI.closed && aI.covers && h == 0) { aH.children(":eq(" + h + ")").after(i) } else { if (h == ax) { aH.children(":eq(" + (h - 1) + ")").after(i) } else { aH.children(":eq(" + h + ")").before(i) } } }
                ax = aH.children().length;
                L = { options: a.extend({}, aI), index: h, page: aH.children(":eq(" + h + ")")[0] };
                if (aI.add) { aH.off(E.add + ".booklet").on(E.add + ".booklet", aI.add) }
                aH.trigger(E.add, L);
                r();
                a6();
                ba();
            ...
            a9 = function(h) {
                if (h == "start") { h = 0 } else { if (h == "end") { h = ax } else { if (typeof h == "number") { if (h < 0 || h > ax) { return } } else { if (typeof h == "undefined") { return } } } }
                if (aH.children(".b-page").length == 2 && aH.find(".b-page-blank").length > 0) { return }
                ak();
                bf();
                if (h >= aI.currentIndex) { if (h > 0 && (h % 2) != 0) { aI.currentIndex -= 2 } if (aI.currentIndex < 0) { aI.currentIndex = 0 } }
                var i;
                if (aI.closed && aI.covers && h == ax) { i = aH.children(":eq(" + (h - 1) + ")").remove() } else { if (aI.closed && aI.covers && h == 0) { i = aH.children(":eq(" + h + ")").remove() } else { if (h == ax) { i = aH.children(":eq(" + (h - 1) + ")").remove() } else { i = aH.children(":eq(" + h + ")").remove() } } }
                ax = aH.children().length;
                L = { options: a.extend({}, aI), index: h, page: i[0] };
                if (aI.remove) { aH.off(E.remove + ".booklet").on(E.remove + ".booklet", aI.remove) }
            ...
            aM = function() { if (!aj && !Q) { if (aS && aI.currentIndex + 2 >= aI.pageTotal) { F(0) } else { F(aI.currentIndex + 2) } } },
            M = function() { if (!aj && !Q) { if (aS && aI.currentIndex - 2 < 0) { F(aI.pageTotal - 2) } else { F(aI.currentIndex - 2) } } },
            F = function(h) {
                var i;
                if (h < aI.pageTotal && h >= 0 && !aj && !Q) {
                    if (h > aI.currentIndex) {
                        aj = true;
                        z = h - aI.currentIndex;
                        aI.currentIndex = h;
                        aI.movingForward = true;
                        L = { options: a.extend({}, aI), index: h, pages: [u[h].contentNode, u[h + 1].contentNode] };
                        if (aI.start) { aH.off(E.start + ".booklet").on(E.start + ".booklet", aI.start) }
                        aH.trigger(E.start, L);
                        v();
                        if (h == aI.pageTotal - 2) { R() }
                        ...
                        } else { aD.stop().animate(am.p2, i, aL === true ? aI.easeOut : aI.easeIn) }
                        if (aL) {
                            aB.animate(am.p3out, i, aI.easeOut);
                            k.animate(am.p3wrapOut, i, aI.easeOut, function() { aa() })
                        } else {
                            aB.stop().animate(am.p3in, i, aI.easeIn).animate(am.p3out, i, aI.easeOut);
                            k.animate(am.p3wrapIn, i, aI.easeIn).animate(am.p3wrapOut, i, aI.easeOut, function() { aa() })
                        }
                    } else {
                        if (h < aI.currentIndex) {
                            aj = true;
                            ...
                            if (s) {
                                ...
                                } else { aG.animate(am.p0, i, aI.easeOut) }
                                aP.animate(am.p0wrapDrag, i, aI.easeOut, function() { aa() })
                            } else {
                                ...
                                } else { aG.animate(am.p0in, i, aI.easeIn).animate(am.p0out, i, aI.easeOut) }
                                aP.animate(am.p0wrapIn, i, aI.easeIn).animate(am.p0wrapOut, i, aI.easeOut, function() { aa() })
                            }
                        }
                    }
                }
            ...
            aW = function(h) {
                if (!Q && ((aI.hovers && aI.overlays) || aI.manual)) {
                    if (h) {
                        if (!aj && !f && !aR && !aL && aI.currentIndex + 2 <= aI.pageTotal - 2) {
                            aD.stop().animate(am.hover.p2, am.hover.speed, aI.easing);
                            aB.addClass("b-grab");
                            if (aI.closed && aI.autoCenter && aI.currentIndex == 0) { aB.stop().animate(am.hover.p3closed, am.hover.speed, aI.easing) } else { aB.stop().animate(am.hover.p3, am.hover.speed, aI.easing) }
                            k.stop().animate(am.hover.p3wrap, am.hover.speed, aI.easing);
                            if (aI.shadows && !a.support.opacity) { bc.css({ right: "auto", left: "-40%" }) }
                            f = true
                        }
                    } else {
                        if (!aj && !aR && !f && !s && aI.currentIndex - 2 >= 0) {
                            ...
                            if (aI.shadows && !a.support.opacity) { be.css({ left: -0.38 * K }) }
                            aR = true
                        }
                    }
                }
                ...
                if (!Q && ((aI.hovers && aI.overlays) || aI.manual)) {
                    if (h) {
                        if (!aj && f && !aL && aI.currentIndex + 2 <= aI.pageTotal - 2) {
                            ...
                            if (aI.shadows && !a.support.opacity) { bc.css({ left: "auto" }) }
                            f = false
                        }
                    } else {
            ...
            G = function(j, i, bh, h) {
                if (i && j > 2) {
                    ...
                    if (f) { aB.css({ left: aI.width - 40, width: 20, "padding-left": 10 }) }
                    if (aI.shadows) {
                    ...
                    if (!i && j > 2) {
                        ...
                        bd = aH.find(".b-pN .b-wrap");
                        aP = aH.find(".b-p0 .b-wrap");
                        if (aI.closed && aI.autoCenter) { V.css({ left: 0 }) }
                        aP.css(aN.p0wrap);
                        if (aR) {
                ...
                if (aI.closed) { if (!i && aI.currentIndex == 0) { V.hide() } else { if (!i) { V.show() } } if (i && aI.currentIndex >= aI.pageTotal - 2) { ay.hide() } else { if (i) { ay.show() } } }
                if (aI.shadows) {
                    if (a.support.opacity) {
                        if (!aL && !s) { bh.animate({ opacity: 1 }, h, aI.easeIn) }
                        bh.animate({ opacity: 0 }, h, aI.easeOut)
                    } else { if (i) { bh.animate({ right: aI.shadowTopFwdWidth }, h * 2, aI.easeIn) } else { bh.animate({ left: aI.shadowTopBackWidth }, h * 2, aI.easeIn) } }
                }
                if (aI.closed && aI.autoCenter) {
                    if (aI.currentIndex == 0) {
                        aB.hide();
                        ...
                        } else { aH.animate({ width: aI.width }, h * 2, aI.easing) }
                    }
                }
            },
            aa = function() {
                ...
                aj = false;
                L = { options: a.extend({}, aI), index: aI.currentIndex, pages: [u[aI.currentIndex].contentNode, u[aI.currentIndex + 1].contentNode] };
                if (aI.change) { aH.off(E.change + ".booklet").on(E.change + ".booklet", aI.change) }
        ...
        return {
            ...
            prev: M,
            gotopage: function(h) {
                if (typeof h === "string") { if (h == "start") { h = 0 } else { if (h == "end") { h = aI.pageTotal - 2 } else { this.gotopage(parseInt(h)) } } } else { if (typeof h === "number") { if (h < 0 || h >= aI.pageTotal) { return } } else { if (typeof h === "undefined") { return } } }
                if (h % 2 != 0) { h -= 1 }
                if (aI.direction == aO.rightToLeft) { h = Math.abs(h - aI.pageTotal) - 2 }
                F(h)
            },
            add: A,
            remove: a9,
            option: function(h, i) {
                if (typeof h === "string") {
                    if (typeof aI[h] !== "undefined") {
                        if (typeof i !== "undefined") {
                            aI[h] = i;
                            a6()
                        } else { return aI[h] }
                    } else { a.error('Option "' + h + '" does not exist on jQuery.booklet.') }
                } else { if (typeof h === "object") { a6(h) } else { if (typeof h === "undefined" || !h) { return a.extend({}, aI) } } }
            }
        }
    }
