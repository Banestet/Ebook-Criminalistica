...
(function($) {
                ...
                if (options.menu && $(options.menu).length > 0) {
                    ...
                    if (options.pageSelector && menu.find('.b-selector-page').length == 0) {
                        ...
                        for (i = 0; i < options.pageTotal; i += 2) {
                            ...
                            // add the list item
                            pageListItem = $('<li><a href="#' + hashRoot + (i + 1) + '" id="selector-page-' + i + '"><span class="b-text">' + listItemTitle + '</span>').appendTo(pageSelectorList);
    ...
    $.fn.booklet.defaults = {
        ...
        closedFrontTitle: 'Portada', // used with "closed", "menu" and "pageSelector", determines title of blank starting page
        closedFrontChapter: 'Inicio del libro', // used with "closed", "menu" and "chapterSelector", determines chapter name of blank starting page
        closedBackTitle: 'Fin', // used with "closed", "menu" and "pageSelector", determines chapter name of blank ending page
        closedBackChapter: 'Fin del libro', // used with "closed", "menu" and "chapterSelector", determines chapter name of blank ending page
        ...
        hoverWidth: 20, // default width for page-turn hover preview
        ...
        nextControlTitle: 'Página siguiente', // text for title attributes of all 'next' controls
        previousControlTitle: 'Página anterior', // text for title attributes of all 'previous' controls
